<template>
  ...
  >
    <div
      v-show="showTool"
      class="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-full pr-1"
    >
    ...
    <div
      v-if="isSelected"
      class="absolute right-0 top-0 translate-y-1/2 translate-x-full"
    >
      <div class="flex flex-col tool-list">
        <div
          v-for="tool in tools"
          :key="tool.event"
          class="bg-white tool-item"
